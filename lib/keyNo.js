...
exports.resultFunction = function(keyNo, critical) {
  return function(dices, log) {
    console.log(dices)
    var result = dices.reduce(function(prev, current, i, arr) { return prev + current })
      , face = table[keyNo][result-1]
    return ("威力表: "+keyNo+" (C値: "+critical+") ... [ 出目 : "+
      dices[0]+", "+dices[1]+" = "+result+
      (critical <= result ? " Critical!!!" : "" )+" ] = [ 結果 : "+face+" ]")
  }
}
...
exports.apply = function(data) {
  ...
  var resultFunction = exports.resultFunction(keyNo, critical)
