...
exports.roll = function (diceString) {
  var result = 0
    ...
    , log = []
  do {
    var nextIsDice = exports.nextIsDiceSection(tmpDiceString)
      , nextIsScalar = exports.nextIsScalarSection(tmpDiceString)
    if ( nextIsDice ) {
